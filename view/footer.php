<footer>
							...
							<div class="row row-cols">
								<div class="col-md-4 col-popular-post hidden-xs">
									...
									<ul class="list-unstyled">
										<li>
											<h5>Neque porroquisquam est, quister.</h5>
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<p class="hidden-xs"><a href="tel:1.855ORLCYTY"><i class="fa fa-phone"></i>1.855.ORL.CYTY</a></p>
									...
									<ul class="list-unstyled list-social">
										...
										<li>
											<a href="#" target="blank"><i class="fa fa-pinterest-p"></i></a>
										</li>
										<li class="page-up">
											<a href="#" id="page-up" target="blank"><i class="fa fa-chevron-up"></i></a>
										</li>
			...
			<div class="row row-inf">
				<div class="container copyright-mobile">
					...
					<p class="pull-right text-roxo">Created by HCODE in Undemy</p>
